...
<html lang="en" class="js"><head>
    ...
    <link rel="stylesheet" href="scripts/dragndrop.css">
...
<div class="container" role="main">
    <form method="post" action="upload.php" enctype="multipart/form-data" novalidate="" class="box has-advanced-upload">
        <div class="box__input">
            ...
            <label for="file"><strong>Choose a file</strong><span class="box__dragndrop"> or drag it here. <br> (Only pdf doc and docx are supported)</span>.</label>
            <button type="submit" class="box__button">Upload</button>
        </div>
        <div class="box__uploading">Uploading…</div>
        <div class="box__success">Done! View the file in:<br> <a id=file_link href=""></a> <br> <a href="/" class="box__restart" role="button">Upload more?</a></div>
